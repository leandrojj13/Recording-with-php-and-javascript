...
<article class="">
              ...
              <div class="card">
                <center>
                  <div class="mdl-card__title">
                    <h2 class="mdl-card__title-text">Grábate!</h2>
                  </div>
                </center>
  ...
  <!--
            <div class="col s12 m4 l4">
                <div class="card">
                    <div class="card-image waves-effect waves-block waves-light">
                        <img class="activator" src="http://www.revistamercado.do/app2/wp-content/uploads/2015/04/Danilo-9.jpg">
                    </div>
                    <div class="card-content">
            ...
            recordingDIV.querySelector('button').onclick = function() {
                ...
                if(button.innerHTML === 'Stop Recording') {
                    ...
                    if(button.recordRTC) {
                     ...
                     //document.querySelector('#upload-to-server').click();
                    return;
                }
...
*/
                            ...
                            recordingPlayer.play(); //aquii empezamos a guardar por minisegundos!
                            recordingPlayer.onended = function() {
                                recordingPlayer.pause();
...
/*            function captureAudio(config) {
            ...
            recordingMedia.onchange = function() {
              /*  if(this.value === 'record-audio') {
               ...
               // setMediaContainerFormat(['Mp4', /*'Webm',*/ 'Gif']);
            //};*/
            // Important!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
